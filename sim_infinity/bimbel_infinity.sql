...
INSERT INTO `access` (`id_access`, `nama`, `role`) VALUES
(1, 'Operator Console', ''),
(2, 'Komisaris', ''),
(3, 'CEO', ''),
(4, 'COBD', ''),
...
(11, 'Sarana Prasarana', ''),
(12, 'Kepala Divisi Public Relation', ''),
(13, 'Public Relation', ''),
(14, 'Staf CMO', ''),
(15, 'Mitra Cabang (Kepala Cabang)', ''),
(16, 'Konsultan Cabang', ''),
(17, 'Koordinator Pengajar', ''),
(18, 'Pengajar', '');
...
CREATE TABLE `cabang` (
  `id_cabang` char(10) COLLATE utf8_unicode_ci NOT NULL,
  `id_kecamatan` char(7) COLLATE utf8_unicode_ci DEFAULT NULL,
  `nama` varchar(100) CHARACTER SET latin1 NOT NULL,
  ...
  `lat` float NOT NULL,
  `lng` float NOT NULL,
  `no_telp` varchar(16) CHARACTER SET latin1 NOT NULL,
  `no_fax` varchar(16) CHARACTER SET latin1 NOT NULL,
  `id_user_kc` int(11) DEFAULT NULL
) ENGINE=InnoDB DEFAULT CHARSET=utf8 COLLATE=utf8_unicode_ci;
...
INSERT INTO `cabang` (`id_cabang`, `id_kecamatan`, `nama`, `alamat`, `kode_pos`, `email`, `lat`, `lng`, `no_telp`, `no_fax`, `id_user_kc`) VALUES
('PUSAT', '3674060', 'Kantor Pusat Bimbel Infinity', 'Jalan Pisok I Blok EA 15 No.1. Bintaro Sektor 5 Jurangmangu', '15222', 'admin@bimbelinfinity.co.id', -6.26536, 106.735, '021-7358675', '-', NULL);
...
INSERT INTO `kabupaten` (`id_kabupaten`, `id_provinsi`, `name`) VALUES
...
INSERT INTO `kecamatan` (`id_kecamatan`, `id_kabupaten`, `name`) VALUES
...
CREATE TABLE `log_data` (
  `id_log_data` int(11) NOT NULL,
  `status` set('error','success') NOT NULL,
  ...
  `type` set('insert','update','delete') NOT NULL
...
INSERT INTO `log_data` (`id_log_data`, `status`, `log_data`, `id_user`, `tanggal`, `ip`, `device`, `agent`, `type`) VALUES
(10, 'error', 'UPDATE `user` SET `id_user` = ''1'', `no_pegawai` = ''123123123'', `nama` = ''Alif Bintoro'', `divisi` = ''Staff IT'', `email` = ''alifbintoro77@gmail.com'', `no_telp` = ''089679974236'', `alamat` = ''Kartasura'', `status` = ''tetap''\nWHERE `id_user` = ''1''', 1, '2017-11-29 09:56:17', '::1', 'Windows 10', 'Mozilla/5.0 (Windows NT 10.0; Win64; x64) AppleWebKit/537.36 (KHTML, like Gecko) Chrome/62.0.3202.94 Safari/537.36', 'update'),
(11, 'success', 'UPDATE `user` SET `id_user` = 1, `password` = ''6728a2ec6d65663fd0617a1d25977045''\nWHERE `id_user` = 1', 1, '2017-11-29 09:56:24', '::1', 'Windows 10', 'Mozilla/5.0 (Windows NT 10.0; Win64; x64) AppleWebKit/537.36 (KHTML, like Gecko) Chrome/62.0.3202.94 Safari/537.36', 'update'),
(12, 'success', 'UPDATE `user` SET `id_user` = ''1'', `nama` = ''Alif Bintoro'', `no_telp` = ''089679974236'', `password` = ''d9b1d7db4cd6e70935368a1efb10e377'', `alamat` = ''Kartasura''\nWHERE `id_user` = ''1''', 1, '2017-11-29 09:57:19', '::1', 'Windows 10', 'Mozilla/5.0 (Windows NT 10.0; Win64; x64) AppleWebKit/537.36 (KHTML, like Gecko) Chrome/62.0.3202.94 Safari/537.36', 'update'),
(13, 'success', 'UPDATE `user` SET `id_user` = ''1'', `no_pegawai` = ''123321123'', `nama` = ''Alif Bintoro'', `divisi` = ''Staff IT'', `email` = ''alifbintoro77@gmail.com'', `no_telp` = ''089679974236'', `alamat` = ''Kartasura'', `status` = ''tetap''\nWHERE `id_user` = ''1''', 1, '2017-11-29 09:57:43', '::1', 'Windows 10', 'Mozilla/5.0 (Windows NT 10.0; Win64; x64) AppleWebKit/537.36 (KHTML, like Gecko) Chrome/62.0.3202.94 Safari/537.36', 'update'),
(14, 'success', 'INSERT INTO `otorisasi` (`id_otorisasi`, `id_user`, `id_access`, `tanggal_input`, `mulai_tanggal`, `selesai_tanggal`) VALUES ('''', ''1'', ''7'', ''2017-11-29 17:03:46'', ''2017-11-29'', ''2017-11-29'')', 1, '2017-11-29 10:03:46', '::1', 'Windows 10', 'Mozilla/5.0 (Windows NT 10.0; Win64; x64) AppleWebKit/537.36 (KHTML, like Gecko) Chrome/62.0.3202.94 Safari/537.36', 'insert'),
(15, 'success', 'INSERT INTO `otorisasi` (`id_otorisasi`, `id_user`, `id_access`, `tanggal_input`, `mulai_tanggal`, `selesai_tanggal`) VALUES ('''', ''1'', ''1'', ''2017-11-29 17:03:55'', ''2017-11-29'', ''2017-11-29'')', 1, '2017-11-29 10:03:55', '::1', 'Windows 10', 'Mozilla/5.0 (Windows NT 10.0; Win64; x64) AppleWebKit/537.36 (KHTML, like Gecko) Chrome/62.0.3202.94 Safari/537.36', 'insert'),
(16, 'success', 'INSERT INTO `user` (`id_user`, `no_pegawai`, `nama`, `divisi`, `email`, `no_telp`, `id_access`, `id_cabang`, `password`, `foto`, `alamat`, `status`) VALUES ('''', ''1233333333333'', ''Dewa Pamungkas'', ''Kepala Cabang'', ''dewa@gmail.com'', ''0897267362736'', ''15'', NULL, ''a366ff7e0a91a4be7fd068744204ade5'', '''', ''Solo'', ''tetap'')', 1, '2017-11-29 10:47:01', '::1', 'Windows 10', 'Mozilla/5.0 (Windows NT 10.0; Win64; x64) AppleWebKit/537.36 (KHTML, like Gecko) Chrome/62.0.3202.94 Safari/537.36', 'insert'),
(17, 'success', 'INSERT INTO `otorisasi` (`id_otorisasi`, `id_user`, `id_access`, `tanggal_input`, `mulai_tanggal`, `selesai_tanggal`) VALUES ('''', 2, ''15'', ''2017-11-29 17:47:01'', ''2017-11-29'', ''2017-11-29'')', 1, '2017-11-29 10:47:01', '::1', 'Windows 10', 'Mozilla/5.0 (Windows NT 10.0; Win64; x64) AppleWebKit/537.36 (KHTML, like Gecko) Chrome/62.0.3202.94 Safari/537.36', 'insert'),
(18, 'success', 'UPDATE `cabang` SET `id_user_kc` = ''2''\nWHERE `id_cabang` = ''PUSAT''', 1, '2017-11-29 11:00:14', '::1', 'Windows 10', 'Mozilla/5.0 (Windows NT 10.0; Win64; x64) AppleWebKit/537.36 (KHTML, like Gecko) Chrome/62.0.3202.94 Safari/537.36', 'update'),
(19, 'success', 'UPDATE `cabang` SET `id_user_kc` = NULL\nWHERE `id_cabang` = ''PUSAT''', 1, '2017-11-30 03:40:08', '::1', 'Windows 10', 'Mozilla/5.0 (Windows NT 10.0; Win64; x64) AppleWebKit/537.36 (KHTML, like Gecko) Chrome/62.0.3202.94 Safari/537.36', 'update'),
(20, 'success', 'UPDATE `cabang` SET `id_user_kc` = ''2''\nWHERE `id_cabang` = ''PUSAT''', 1, '2017-11-30 03:42:04', '::1', 'Windows 10', 'Mozilla/5.0 (Windows NT 10.0; Win64; x64) AppleWebKit/537.36 (KHTML, like Gecko) Chrome/62.0.3202.94 Safari/537.36', 'update'),
(21, 'success', 'UPDATE `cabang` SET `id_user_kc` = NULL\nWHERE `id_cabang` = ''PUSAT''', 1, '2017-11-30 03:42:08', '::1', 'Windows 10', 'Mozilla/5.0 (Windows NT 10.0; Win64; x64) AppleWebKit/537.36 (KHTML, like Gecko) Chrome/62.0.3202.94 Safari/537.36', 'update'),
(22, 'success', 'INSERT INTO `pengajar` (`id_pengajar`, `id_cabang`, `nama`, `jk`, `tmpt_lahir`, `tgl_lahir`, `email`, `no_hp`, `alamat`, `id_kecamatan`, `kode_pengajar`, `no_rek_bni`, `tanggal_masuk`, `bidang`, `grade`, `status`) VALUES ('''', ''PUSAT'', ''Alif Bintoro'', ''m'', ''Surakarta'', ''2017-12-01'', ''alifbintoro77@gmail.com'', ''089679974236'', ''Kartasura'', ''3311120'', ''3456744567'', ''3456785434567743'', ''2017-12-01'', ''tpa'', ''a+'', ''freelance'')', 1, '2017-12-01 07:35:25', '::1', 'Windows 10', 'Mozilla/5.0 (Windows NT 10.0; Win64; x64) AppleWebKit/537.36 (KHTML, like Gecko) Chrome/62.0.3202.94 Safari/537.36', 'insert'),
(23, 'success', 'UPDATE `pengajar` SET `id_pengajar` = 1, `password` = ''5faa4ec1c0b6cce73e529f7d8d741fae''\nWHERE `id_pengajar` = 1', 1, '2017-12-01 09:46:23', '::1', 'Windows 10', 'Mozilla/5.0 (Windows NT 10.0; Win64; x64) AppleWebKit/537.36 (KHTML, like Gecko) Chrome/62.0.3202.94 Safari/537.36', 'update'),
(24, 'success', 'UPDATE `pengajar` SET `id_pengajar` = ''1'', `nama` = ''Alif Bintoro'', `jk` = ''m'', `tmpt_lahir` = ''Surakarta'', `tgl_lahir` = ''1997-05-24'', `email` = ''alifbintoro77@gmail.com'', `no_hp` = ''089679974236'', `alamat` = ''Ngemplak'', `id_kecamatan` = ''3311120'', `kode_pengajar` = ''2147483647'', `no_rek_bni` = ''2147483647'', `tanggal_masuk` = ''2017-12-01'', `bidang` = ''tpa'', `grade` = ''a+'', `status` = ''freelance''\nWHERE `id_pengajar` = ''1''', 1, '2017-12-01 09:56:23', '::1', 'Windows 10', 'Mozilla/5.0 (Windows NT 10.0; Win64; x64) AppleWebKit/537.36 (KHTML, like Gecko) Chrome/62.0.3202.94 Safari/537.36', 'update'),
(25, 'success', 'UPDATE `pengajar` SET `id_pengajar` = 1, `password` = ''c268bed6eb7d77f93f2b34b94247ca2b''\nWHERE `id_pengajar` = 1', 1, '2017-12-01 09:57:37', '::1', 'Windows 10', 'Mozilla/5.0 (Windows NT 10.0; Win64; x64) AppleWebKit/537.36 (KHTML, like Gecko) Chrome/62.0.3202.94 Safari/537.36', 'update'),
(26, 'success', 'DELETE FROM `pengajar`\nWHERE `id_pengajar` = ''1''', 1, '2017-12-01 10:14:03', '::1', 'Windows 10', 'Mozilla/5.0 (Windows NT 10.0; Win64; x64) AppleWebKit/537.36 (KHTML, like Gecko) Chrome/62.0.3202.94 Safari/537.36', 'delete'),
(27, 'success', 'INSERT INTO `siswa` (`nis`, `virtual_account`, `id_cabang`, `no_pendaftaran`, `tahun`, `nama`, `email`, `no_hp`, `tmpt_lahir`, `tgl_lahir`, `jk`, `alamat`, `id_kec_siswa`, `asal_sekolah`, `tahun_lulus`, `jurusan`, `nama_wali`, `alamat_wali`, `id_kec_wali`, `no_hp_wali`, `email_wali`, `id_program`) VALUES (''17.0001.12.2'', '''', ''PUSAT'', ''0001'', ''2017'', ''Budi Prasetya'', ''budi.prasetya@gmail.com'', ''087773445332'', ''asd'', ''2017-12-01'', ''m'', ''asd'', ''3372040'', ''sd'', ''2016'', ''asdf'', ''asdasf'', ''sdafsdfa'', ''3372020'', ''786876876'', ''wali@gmail.com'', ''12'')', 1, '2017-12-01 10:49:03', '::1', 'Windows 10', 'Mozilla/5.0 (Windows NT 10.0; Win64; x64) AppleWebKit/537.36 (KHTML, like Gecko) Chrome/62.0.3202.94 Safari/537.36', 'insert'),
(28, 'success', 'INSERT INTO `siswa_pembayaran` (`id_pembayaran`, `nis_siswa`, `biaya_program`, `biaya_pendaftaran`, `diskon`) VALUES ('''', ''17.0001.12.2'', ''1500000'', ''295000'', 0)', 1, '2017-12-01 10:49:03', '::1', 'Windows 10', 'Mozilla/5.0 (Windows NT 10.0; Win64; x64) AppleWebKit/537.36 (KHTML, like Gecko) Chrome/62.0.3202.94 Safari/537.36', 'insert'),
(29, 'success', 'INSERT INTO `req_pembayaran_khusus` (`id_req_pembayaran`, `nomor`, `tanggal_input`, `id_user_konsultan`, `id_cabang`, `nis`, `cicilan1`, `cicilan2`, `cicilan3`, `cicilan4`, `id_user_man`, `disetujui`) VALUES ('''', ''0001'', ''2017-12-01 22:21:44'', ''1'', ''PUSAT'', ''17.0001.12.2'', ''1'', ''2'', ''2'', ''2'', NULL, ''0'')', 1, '2017-12-01 15:21:44', '::1', 'Windows 10', 'Mozilla/5.0 (Windows NT 10.0; Win64; x64) AppleWebKit/537.36 (KHTML, like Gecko) Chrome/62.0.3202.94 Safari/537.36', 'insert'),
(30, 'success', 'UPDATE `siswa` SET `nis` = ''17.0001.14.2'', `nama` = ''Budi Prasetya'', `email` = ''budi.prasetya@gmail.com'', `no_hp` = ''087773445332'', `tmpt_lahir` = ''Surakarta'', `tgl_lahir` = ''1998-12-07'', `jk` = ''m'', `alamat` = ''Kentingan'', `id_kec_siswa` = ''3372040'', `asal_sekolah` = ''SMA N 1 SURAKARTA'', `tahun_lulus` = ''2016'', `jurusan` = ''IPA'', `nama_wali` = ''Supomo'', `alamat_wali` = ''Kentingan'', `id_kec_wali` = ''3372040'', `no_hp_wali` = ''081654123345'', `email_wali` = ''wali@gmail.com'', `id_program` = ''14''\nWHERE `nis` = ''17.0001.12.2''', 1, '2017-12-01 15:36:07', '::1', 'Windows 10', 'Mozilla/5.0 (Windows NT 10.0; Win64; x64) AppleWebKit/537.36 (KHTML, like Gecko) Chrome/62.0.3202.94 Safari/537.36', 'update'),
(31, 'success', 'UPDATE `siswa` SET `nama` = ''Budi Prasetya'', `email` = ''budi.prasetya@gmail.com'', `no_hp` = ''087773445332'', `tmpt_lahir` = ''Surakarta'', `tgl_lahir` = ''1998-12-07'', `jk` = ''m'', `alamat` = ''Kentingan'', `id_kec_siswa` = ''3372040'', `asal_sekolah` = ''SMA N 1 SURAKARTA'', `tahun_lulus` = ''2016'', `jurusan` = ''IPA'', `nama_wali` = ''Supomo'', `alamat_wali` = ''Kentingan'', `id_kec_wali` = ''3372040'', `no_hp_wali` = ''081654123345'', `email_wali` = ''supomo@gmail.com'', `id_program` = ''14''\nWHERE `nis` = ''17.0001.14.2''', 1, '2017-12-01 15:37:36', '::1', 'Windows 10', 'Mozilla/5.0 (Windows NT 10.0; Win64; x64) AppleWebKit/537.36 (KHTML, like Gecko) Chrome/62.0.3202.94 Safari/537.36', 'update'),
(32, 'success', 'UPDATE `siswa` SET `nis` = ''17.0001.14.2'', `nama` = ''Budi Prasetya'', `email` = ''budi.prasetya@gmail.com'', `no_hp` = ''087773445332'', `tmpt_lahir` = ''Surakarta'', `tgl_lahir` = ''1998-12-07'', `jk` = ''m'', `alamat` = ''Kentingan'', `id_kec_siswa` = ''3372040'', `asal_sekolah` = ''SMA N 1 SURAKARTA'', `tahun_lulus` = ''2016'', `jurusan` = ''IPA'', `nama_wali` = ''Supomo'', `alamat_wali` = ''Kentingan'', `id_kec_wali` = ''3372040'', `no_hp_wali` = ''081654123345'', `email_wali` = ''supomo11@gmail.com'', `id_program` = ''14''\nWHERE `nis` = ''17.0001.14.2''', 1, '2017-12-01 15:40:55', '::1', 'Windows 10', 'Mozilla/5.0 (Windows NT 10.0; Win64; x64) AppleWebKit/537.36 (KHTML, like Gecko) Chrome/62.0.3202.94 Safari/537.36', 'update'),
(33, 'success', 'UPDATE `siswa` SET `nis` = ''17.0001.14.1'', `nama` = ''Budi Prasetya'', `email` = ''budi.prasetya@gmail.com'', `no_hp` = ''087773445332'', `tmpt_lahir` = ''Surakarta'', `tgl_lahir` = ''1998-12-07'', `jk` = ''f'', `alamat` = ''Kentingan'', `id_kec_siswa` = ''3372040'', `asal_sekolah` = ''SMA N 1 SURAKARTA'', `tahun_lulus` = ''2016'', `jurusan` = ''IPA'', `nama_wali` = ''Supomo'', `alamat_wali` = ''Kentingan'', `id_kec_wali` = ''3372040'', `no_hp_wali` = ''081654123345'', `email_wali` = ''supomo11@gmail.com'', `id_program` = ''14''\nWHERE `nis` = ''17.0001.14.2''', 1, '2017-12-01 15:41:13', '::1', 'Windows 10', 'Mozilla/5.0 (Windows NT 10.0; Win64; x64) AppleWebKit/537.36 (KHTML, like Gecko) Chrome/62.0.3202.94 Safari/537.36', 'update'),
(34, 'success', 'UPDATE `siswa` SET `nis` = ''17.0001.14.2'', `nama` = ''Budi Prasetya'', `email` = ''budi.prasetya@gmail.com'', `no_hp` = ''087773445332'', `tmpt_lahir` = ''Surakarta'', `tgl_lahir` = ''1998-12-07'', `jk` = ''m'', `alamat` = ''Kentingan'', `id_kec_siswa` = ''3372040'', `asal_sekolah` = ''SMA N 1 SURAKARTA'', `tahun_lulus` = ''2016'', `jurusan` = ''IPA'', `nama_wali` = ''Supomo'', `alamat_wali` = ''Kentingan'', `id_kec_wali` = ''3372040'', `no_hp_wali` = ''081654123345'', `email_wali` = ''supomo11@gmail.com'', `id_program` = ''14''\nWHERE `nis` = ''17.0001.14.1''', 1, '2017-12-01 15:41:24', '::1', 'Windows 10', 'Mozilla/5.0 (Windows NT 10.0; Win64; x64) AppleWebKit/537.36 (KHTML, like Gecko) Chrome/62.0.3202.94 Safari/537.36', 'update'),
(35, 'success', 'UPDATE `siswa` SET `nis` = ''17.0001.14.1'', `nama` = ''Budi Prasetya'', `email` = ''budi.prasetya@gmail.com'', `no_hp` = ''087773445332'', `tmpt_lahir` = ''Surakarta'', `tgl_lahir` = ''1998-12-07'', `jk` = ''f'', `alamat` = ''Kentingan'', `id_kec_siswa` = ''3372040'', `asal_sekolah` = ''SMA N 1 SURAKARTA'', `tahun_lulus` = ''2016'', `jurusan` = ''IPA'', `nama_wali` = ''Supomo'', `alamat_wali` = ''Kentingan'', `id_kec_wali` = ''3372040'', `no_hp_wali` = ''081654123345'', `email_wali` = ''supomo11@gmail.com'', `id_program` = ''14''\nWHERE `nis` = ''17.0001.14.2''', 1, '2017-12-01 15:51:10', '::1', 'Windows 10', 'Mozilla/5.0 (Windows NT 10.0; Win64; x64) AppleWebKit/537.36 (KHTML, like Gecko) Chrome/62.0.3202.94 Safari/537.36', 'update'),
(36, 'success', 'UPDATE `req_pembayaran_khusus` SET `id_req_pembayaran` = ''1'', `nis` = ''17.0001.14.1'', `cicilan1` = ''1'', `cicilan2` = ''2'', `cicilan3` = ''23'', `cicilan4` = ''2''\nWHERE `id_req_pembayaran` = ''1''', 1, '2017-12-02 06:15:39', '::1', 'Windows 10', 'Mozilla/5.0 (Windows NT 10.0; Win64; x64) AppleWebKit/537.36 (KHTML, like Gecko) Chrome/62.0.3202.94 Safari/537.36', 'update'),
(37, 'success', 'UPDATE `req_pembayaran_khusus` SET `id_req_pembayaran` = ''1'', `nis` = ''17.0001.14.1'', `cicilan1` = ''1'', `cicilan2` = ''20'', `cicilan3` = ''23'', `cicilan4` = ''2''\nWHERE `id_req_pembayaran` = ''1''', 1, '2017-12-02 06:18:32', '::1', 'Windows 10', 'Mozilla/5.0 (Windows NT 10.0; Win64; x64) AppleWebKit/537.36 (KHTML, like Gecko) Chrome/62.0.3202.94 Safari/537.36', 'update'),
(38, 'success', 'UPDATE `req_pembayaran_khusus` SET `id_req_pembayaran` = ''1'', `nis` = ''17.0001.14.1'', `cicilan1` = ''10'', `cicilan2` = ''20'', `cicilan3` = ''23'', `cicilan4` = ''2''\nWHERE `id_req_pembayaran` = ''1''', 1, '2017-12-02 06:22:35', '::1', 'Windows 10', 'Mozilla/5.0 (Windows NT 10.0; Win64; x64) AppleWebKit/537.36 (KHTML, like Gecko) Chrome/62.0.3202.94 Safari/537.36', 'update'),
(39, 'error', 'UPDATE `req_pembayaran_khusus` SET `id_req_pembayaran` = ''1'', `nis` = ''17.0001.14.1'', `cicilan1` = ''10'', `cicilan2` = ''20'', `cicilan3` = ''23'', `cicilan4` = ''2''\nWHERE `id_req_pembayaran` = ''1''', 1, '2017-12-02 06:23:55', '::1', 'Windows 10', 'Mozilla/5.0 (Windows NT 10.0; Win64; x64) AppleWebKit/537.36 (KHTML, like Gecko) Chrome/62.0.3202.94 Safari/537.36', 'update'),
(40, 'success', 'UPDATE `req_pembayaran_khusus` SET `id_req_pembayaran` = ''1'', `nis` = ''17.0001.14.1'', `cicilan1` = ''15'', `cicilan2` = ''20'', `cicilan3` = ''23'', `cicilan4` = ''2''\nWHERE `id_req_pembayaran` = ''1''', 1, '2017-12-02 06:24:01', '::1', 'Windows 10', 'Mozilla/5.0 (Windows NT 10.0; Win64; x64) AppleWebKit/537.36 (KHTML, like Gecko) Chrome/62.0.3202.94 Safari/537.36', 'update'),
(41, 'success', 'INSERT INTO `req_virtual_account` (`id_req_va`, `id_user_konsultan`, `id_cabang`, `nomor`, `tahun`, `id_user_man`, `disetujui`) VALUES ('''', ''1'', ''PUSAT'', ''0001'', ''2017'', NULL, 0)', 1, '2017-12-02 16:09:03', '::1', 'Windows 10', 'Mozilla/5.0 (Windows NT 10.0; Win64; x64) AppleWebKit/537.36 (KHTML, like Gecko) Chrome/62.0.3202.94 Safari/537.36', 'insert'),
(42, 'success', 'INSERT INTO `req_virtual_account` (`id_req_va`, `id_user_konsultan`, `id_cabang`, `nomor`, `tahun`, `id_user_man`, `disetujui`) VALUES ('''', ''1'', ''PUSAT'', ''0002'', ''2017'', NULL, 0)', 1, '2017-12-02 16:10:30', '::1', 'Windows 10', 'Mozilla/5.0 (Windows NT 10.0; Win64; x64) AppleWebKit/537.36 (KHTML, like Gecko) Chrome/62.0.3202.94 Safari/537.36', 'insert'),
(43, 'success', 'INSERT INTO `req_virtual_account` (`id_req_va`, `id_user_konsultan`, `id_cabang`, `nomor`, `tahun`, `id_user_man`, `disetujui`) VALUES ('''', ''1'', ''PUSAT'', ''0001'', ''2017'', NULL, 0)', 1, '2017-12-02 16:20:52', '::1', 'Windows 10', 'Mozilla/5.0 (Windows NT 10.0; Win64; x64) AppleWebKit/537.36 (KHTML, like Gecko) Chrome/62.0.3202.94 Safari/537.36', 'insert'),
(44, 'success', 'INSERT INTO `req_virtual_account` (`id_req_va`, `id_user_konsultan`, `id_cabang`, `nomor`, `tahun`, `id_user_man`, `disetujui`) VALUES ('''', ''1'', ''PUSAT'', ''0002'', ''2017'', NULL, 0)', 1, '2017-12-02 16:23:13', '::1', 'Windows 10', 'Mozilla/5.0 (Windows NT 10.0; Win64; x64) AppleWebKit/537.36 (KHTML, like Gecko) Chrome/62.0.3202.94 Safari/537.36', 'insert'),
(45, 'success', 'INSERT INTO `req_virtual_account` (`id_req_va`, `id_user_konsultan`, `id_cabang`, `nomor`, `tahun`, `id_user_man`, `disetujui`) VALUES ('''', ''1'', ''PUSAT'', ''0003'', ''2017'', NULL, 0)', 1, '2017-12-02 16:26:10', '::1', 'Windows 10', 'Mozilla/5.0 (Windows NT 10.0; Win64; x64) AppleWebKit/537.36 (KHTML, like Gecko) Chrome/62.0.3202.94 Safari/537.36', 'insert'),
(46, 'success', 'INSERT INTO `req_virtual_account` (`id_req_va`, `id_user_konsultan`, `id_cabang`, `nomor`, `tahun`, `id_user_man`, `disetujui`) VALUES ('''', ''1'', ''PUSAT'', ''0001'', ''2017'', NULL, 0)', 1, '2017-12-02 16:27:45', '::1', 'Windows 10', 'Mozilla/5.0 (Windows NT 10.0; Win64; x64) AppleWebKit/537.36 (KHTML, like Gecko) Chrome/62.0.3202.94 Safari/537.36', 'insert'),
(47, 'success', 'INSERT INTO `sub_req_virtual_account` (`id_req_va`, `id_sub_req_va`, `nis`, `virtual_account`) VALUES (1,'''',''17.0001.14.1'',''111111111'')', 1, '2017-12-02 16:27:45', '::1', 'Windows 10', 'Mozilla/5.0 (Windows NT 10.0; Win64; x64) AppleWebKit/537.36 (KHTML, like Gecko) Chrome/62.0.3202.94 Safari/537.36', 'insert'),
(48, 'success', 'INSERT INTO `req_virtual_account` (`id_req_va`, `id_user_konsultan`, `id_cabang`, `nomor`, `tahun`, `id_user_man`, `disetujui`) VALUES ('''', ''1'', ''PUSAT'', ''0001'', ''2017'', NULL, 0)', 1, '2017-12-04 11:26:46', '::1', 'Windows 10', 'Mozilla/5.0 (Windows NT 10.0; Win64; x64) AppleWebKit/537.36 (KHTML, like Gecko) Chrome/62.0.3202.94 Safari/537.36', 'insert'),
(49, 'success', 'INSERT INTO `sub_req_virtual_account` (`id_req_va`, `id_sub_req_va`, `nis`, `virtual_account`) VALUES (1,'''',''17.0001.14.1'',''1111111111'')', 1, '2017-12-04 11:26:46', '::1', 'Windows 10', 'Mozilla/5.0 (Windows NT 10.0; Win64; x64) AppleWebKit/537.36 (KHTML, like Gecko) Chrome/62.0.3202.94 Safari/537.36', 'insert'),
(50, 'success', 'DELETE FROM `req_virtual_account`\nWHERE `id_req_va` = ''1''', 1, '2017-12-04 12:11:23', '::1', 'Windows 10', 'Mozilla/5.0 (Windows NT 10.0; Win64; x64) AppleWebKit/537.36 (KHTML, like Gecko) Chrome/62.0.3202.94 Safari/537.36', 'delete'),
(51, 'success', 'INSERT INTO `req_virtual_account` (`id_req_va`, `id_user_konsultan`, `id_cabang`, `nomor`, `tahun`, `id_user_man`, `disetujui`, `tanggal_input`) VALUES ('''', ''1'', ''PUSAT'', ''0001'', ''2017'', NULL, ''0'', ''2017-12-04 19:25:16'')', 1, '2017-12-04 12:25:16', '::1', 'Windows 10', 'Mozilla/5.0 (Windows NT 10.0; Win64; x64) AppleWebKit/537.36 (KHTML, like Gecko) Chrome/62.0.3202.94 Safari/537.36', 'insert'),
(52, 'success', 'INSERT INTO `sub_req_virtual_account` (`id_req_va`, `id_sub_req_va`, `nis`, `virtual_account`) VALUES (2,'''',''17.0001.14.1'',''11111111111'')', 1, '2017-12-04 12:25:16', '::1', 'Windows 10', 'Mozilla/5.0 (Windows NT 10.0; Win64; x64) AppleWebKit/537.36 (KHTML, like Gecko) Chrome/62.0.3202.94 Safari/537.36', 'insert'),
(53, 'success', 'UPDATE `sub_req_virtual_account` SET `virtual_account` = CASE \nWHEN `id_sub_req_va` = ''2'' THEN ''11111111111''\nELSE `virtual_account` END\nWHERE `id_sub_req_va` IN(''2'')', 1, '2017-12-09 07:27:05', '::1', 'Windows 10', 'Mozilla/5.0 (Windows NT 10.0; Win64; x64) AppleWebKit/537.36 (KHTML, like Gecko) Chrome/62.0.3202.94 Safari/537.36', 'update'),
(54, 'success', 'UPDATE `sub_req_virtual_account` SET `virtual_account` = CASE \nWHEN `id_sub_req_va` = ''2'' THEN ''11111111112''\nELSE `virtual_account` END\nWHERE `id_sub_req_va` IN(''2'')', 1, '2017-12-09 07:30:07', '::1', 'Windows 10', 'Mozilla/5.0 (Windows NT 10.0; Win64; x64) AppleWebKit/537.36 (KHTML, like Gecko) Chrome/62.0.3202.94 Safari/537.36', 'update'),
(55, 'success', 'INSERT INTO `notula_rapat` (`id_notula`, `id_cabang`, `id_user_notulen`, `tanggal_input`, `agenda`, `tanggal`, `tempat`, `isi_rapat`) VALUES ('''', ''PUSAT'', ''1'', ''2017-12-10 18:27:07'', ''Judul Agenda Rapat'', ''10-12-2017'', ''Ruang Rapat'', ''<h4>Peserta Rapat:</h4><ol><li>Budi</li><li>Ani</li><li>Andi</li><li>Lusi</li><li>Tino</li></ol><h4>Pembahasan Rapat:</h4><p>Pembahasan tentang rapat saat ini adalah .............................................................................................................</p>'')', 1, '2017-12-10 11:27:07', '::1', 'Windows 10', 'Mozilla/5.0 (Windows NT 10.0; Win64; x64) AppleWebKit/537.36 (KHTML, like Gecko) Chrome/62.0.3202.94 Safari/537.36', 'insert'),
(56, 'error', 'UPDATE `notula_rapat` SET `id_notula` = ''1'', `agenda` = ''Judul Agenda Rapat'', `tanggal` = ''2017-12-10'', `tempat` = ''Ruang Rapat'', `isi_rapat` = ''<h4>Peserta Rapat:</h4><ol><li>Budi</li><li>Ani</li><li>Andi</li><li>Lusi</li><li>Tino</li></ol><h4>Pembahasan Rapat:</h4><p>Pembahasan tentang rapat saat ini adalah .............................................................................................................</p>''\nWHERE `id_notula` = ''1''', 1, '2017-12-10 11:59:39', '::1', 'Windows 10', 'Mozilla/5.0 (Windows NT 10.0; Win64; x64) AppleWebKit/537.36 (KHTML, like Gecko) Chrome/62.0.3202.94 Safari/537.36', 'update'),
(57, 'success', 'UPDATE `notula_rapat` SET `id_notula` = ''1'', `agenda` = ''Judul Agenda Rapat'', `tanggal` = ''2017-12-10'', `tempat` = ''Ruang Rapat'', `isi_rapat` = ''<h4>Peserta Rapat:</h4><ol><li>Budi</li><li>Ani</li><li>Andi</li><li>Lusi</li><li>Tino</li><li>Roni</li></ol><h4>Pembahasan Rapat:</h4><p>Pembahasan tentang rapat saat ini adalah .............................................................................................................</p>''\nWHERE `id_notula` = ''1''', 1, '2017-12-10 11:59:46', '::1', 'Windows 10', 'Mozilla/5.0 (Windows NT 10.0; Win64; x64) AppleWebKit/537.36 (KHTML, like Gecko) Chrome/62.0.3202.94 Safari/537.36', 'update'),
(58, 'success', 'UPDATE `notula_rapat` SET `id_notula` = ''1'', `agenda` = ''Judul Agenda Rapat'', `tanggal` = ''2017-12-09'', `tempat` = ''Ruang Rapat'', `isi_rapat` = ''<h4>Peserta Rapat:</h4><ol><li>Budi</li><li>Ani</li><li>Andi</li><li>Lusi</li><li>Tino</li><li>Roni</li></ol><h4>Pembahasan Rapat:</h4><p>Pembahasan tentang rapat saat ini adalah .............................................................................................................</p>''\nWHERE `id_notula` = ''1''', 1, '2017-12-10 12:00:18', '::1', 'Windows 10', 'Mozilla/5.0 (Windows NT 10.0; Win64; x64) AppleWebKit/537.36 (KHTML, like Gecko) Chrome/62.0.3202.94 Safari/537.36', 'update'),
(59, 'success', 'INSERT INTO `notula_rapat` (`id_notula`, `id_cabang`, `id_user_notulen`, `tanggal_input`, `agenda`, `tanggal`, `tempat`, `isi_rapat`) VALUES ('''', ''PUSAT'', ''1'', ''2017-12-10 19:10:29'', ''jasidj'', ''2017-12-10'', ''askjd'', ''<p>aksdjkasjd</p>'')', 1, '2017-12-10 12:10:29', '::1', 'Windows 10', 'Mozilla/5.0 (Windows NT 10.0; Win64; x64) AppleWebKit/537.36 (KHTML, like Gecko) Chrome/62.0.3202.94 Safari/537.36', 'insert'),
(60, 'error', 'DELETE FROM `notula_rapat`\nWHERE `id_notula` IS NULL', 1, '2017-12-10 12:10:32', '::1', 'Windows 10', 'Mozilla/5.0 (Windows NT 10.0; Win64; x64) AppleWebKit/537.36 (KHTML, like Gecko) Chrome/62.0.3202.94 Safari/537.36', 'delete'),
(61, 'error', 'DELETE FROM `notula_rapat`\nWHERE `id_notula` IS NULL', 1, '2017-12-10 12:10:37', '::1', 'Windows 10', 'Mozilla/5.0 (Windows NT 10.0; Win64; x64) AppleWebKit/537.36 (KHTML, like Gecko) Chrome/62.0.3202.94 Safari/537.36', 'delete'),
(62, 'success', 'DELETE FROM `notula_rapat`\nWHERE `id_notula` = ''2''', 1, '2017-12-10 12:11:02', '::1', 'Windows 10', 'Mozilla/5.0 (Windows NT 10.0; Win64; x64) AppleWebKit/537.36 (KHTML, like Gecko) Chrome/62.0.3202.94 Safari/537.36', 'delete');
...
CREATE TABLE `log_login` (
  ...
  `agent` varchar(150) CHARACTER SET utf8 NOT NULL,
  `device` varchar(20) CHARACTER SET utf8 NOT NULL,
...
INSERT INTO `log_login` (`id_log`, `id_user`, `ip`, `agent`, `device`, `time`) VALUES
(1, 1, '::1', 'Mozilla/5.0 (Windows NT 10.0; Win64; x64) AppleWebKit/537.36 (KHTML, like Gecko) Chrome/62.0.3202.94 Safari/537.36', 'Windows 10', '2017-11-29 09:55:18'),
(2, 1, '::1', 'Mozilla/5.0 (Windows NT 10.0; Win64; x64) AppleWebKit/537.36 (KHTML, like Gecko) Chrome/62.0.3202.94 Safari/537.36', 'Windows 10', '2017-11-29 17:10:19'),
(3, 1, '::1', 'Mozilla/5.0 (Windows NT 10.0; Win64; x64) AppleWebKit/537.36 (KHTML, like Gecko) Chrome/62.0.3202.94 Safari/537.36', 'Windows 10', '2017-11-30 03:25:43'),
(4, 1, '::1', 'Mozilla/5.0 (Windows NT 10.0; Win64; x64) AppleWebKit/537.36 (KHTML, like Gecko) Chrome/62.0.3202.94 Safari/537.36', 'Windows 10', '2017-11-30 13:04:37'),
(5, 1, '::1', 'Mozilla/5.0 (Windows NT 10.0; Win64; x64) AppleWebKit/537.36 (KHTML, like Gecko) Chrome/62.0.3202.94 Safari/537.36', 'Windows 10', '2017-12-01 05:42:52'),
(6, 1, '::1', 'Mozilla/5.0 (Windows NT 10.0; Win64; x64) AppleWebKit/537.36 (KHTML, like Gecko) Chrome/62.0.3202.94 Safari/537.36', 'Windows 10', '2017-12-02 05:51:09'),
(7, 1, '::1', 'Mozilla/5.0 (Windows NT 10.0; Win64; x64) AppleWebKit/537.36 (KHTML, like Gecko) Chrome/62.0.3202.94 Safari/537.36', 'Windows 10', '2017-12-02 11:28:03'),
(8, 1, '::1', 'Mozilla/5.0 (Windows NT 10.0; Win64; x64) AppleWebKit/537.36 (KHTML, like Gecko) Chrome/62.0.3202.94 Safari/537.36', 'Windows 10', '2017-12-04 11:13:59'),
(9, 1, '::1', 'Mozilla/5.0 (Windows NT 10.0; Win64; x64) AppleWebKit/537.36 (KHTML, like Gecko) Chrome/62.0.3202.94 Safari/537.36', 'Windows 10', '2017-12-08 15:56:35'),
(10, 1, '::1', 'Mozilla/5.0 (Windows NT 10.0; Win64; x64) AppleWebKit/537.36 (KHTML, like Gecko) Chrome/62.0.3202.94 Safari/537.36', 'Windows 10', '2017-12-09 06:45:19'),
(11, 1, '::1', 'Mozilla/5.0 (Windows NT 10.0; Win64; x64) AppleWebKit/537.36 (KHTML, like Gecko) Chrome/62.0.3202.94 Safari/537.36', 'Windows 10', '2017-12-09 07:30:53'),
(12, 1, '::1', 'Mozilla/5.0 (Windows NT 10.0; Win64; x64) AppleWebKit/537.36 (KHTML, like Gecko) Chrome/62.0.3202.94 Safari/537.36', 'Windows 10', '2017-12-10 02:03:53'),
(13, 1, '::1', 'Mozilla/5.0 (Windows NT 10.0; Win64; x64) AppleWebKit/537.36 (KHTML, like Gecko) Chrome/62.0.3202.94 Safari/537.36', 'Windows 10', '2017-12-10 05:44:16'),
(14, 1, '::1', 'Mozilla/5.0 (Windows NT 10.0; Win64; x64) AppleWebKit/537.36 (KHTML, like Gecko) Chrome/62.0.3202.94 Safari/537.36', 'Windows 10', '2017-12-10 10:26:58');
...
CREATE TABLE `menu` (
  ...
  `id_main_menu` int(11) DEFAULT NULL
) ENGINE=InnoDB DEFAULT CHARSET=utf8 COLLATE=utf8_unicode_ci;

-- --------------------------------------------------------

--
-- Table structure for table `notula_rapat`
--

CREATE TABLE `notula_rapat` (
  `id_notula` int(11) NOT NULL,
  `id_cabang` char(10) COLLATE utf8_unicode_ci NOT NULL,
  `id_user_notulen` int(11) NOT NULL,
  `tanggal_input` timestamp NOT NULL DEFAULT CURRENT_TIMESTAMP ON UPDATE CURRENT_TIMESTAMP,
  `agenda` varchar(100) COLLATE utf8_unicode_ci NOT NULL,
  `tanggal` date NOT NULL,
  `tempat` varchar(100) COLLATE utf8_unicode_ci NOT NULL,
  `isi_rapat` text COLLATE utf8_unicode_ci NOT NULL
) ENGINE=InnoDB DEFAULT CHARSET=utf8 COLLATE=utf8_unicode_ci;

--
-- Dumping data for table `notula_rapat`
--

INSERT INTO `notula_rapat` (`id_notula`, `id_cabang`, `id_user_notulen`, `tanggal_input`, `agenda`, `tanggal`, `tempat`, `isi_rapat`) VALUES
(1, 'PUSAT', 1, '2017-12-10 12:00:18', 'Judul Agenda Rapat', '2017-12-09', 'Ruang Rapat', '<h4>Peserta Rapat:</h4><ol><li>Budi</li><li>Ani</li><li>Andi</li><li>Lusi</li><li>Tino</li><li>Roni</li></ol><h4>Pembahasan Rapat:</h4><p>Pembahasan tentang rapat saat ini adalah .............................................................................................................</p>');
...
INSERT INTO `otorisasi` (`id_otorisasi`, `id_user`, `id_access`, `tanggal_input`, `mulai_tanggal`, `selesai_tanggal`) VALUES
(1, 1, 1, '2017-11-29 09:11:43', '2017-11-29', '2018-01-31'),
(2, 1, 7, '2017-11-29 10:03:46', '2017-11-29', '2017-11-29'),
(3, 1, 1, '2017-11-29 10:03:55', '2017-11-29', '2017-11-29'),
(4, 2, 15, '2017-11-29 10:47:01', '2017-11-29', '2017-11-29');
...
CREATE TABLE `pengajar` (
  ...
  `id_cabang` char(10) COLLATE utf8_unicode_ci NOT NULL,
  `nama` varchar(100) COLLATE utf8_unicode_ci NOT NULL,
  `tmpt_lahir` varchar(100) COLLATE utf8_unicode_ci NOT NULL,
  `tgl_lahir` date NOT NULL,
  `alamat` text COLLATE utf8_unicode_ci NOT NULL,
  `id_kecamatan` char(7) COLLATE utf8_unicode_ci NOT NULL,
  `no_hp` char(16) COLLATE utf8_unicode_ci NOT NULL,
  `email` varchar(100) COLLATE utf8_unicode_ci NOT NULL,
  `bidang` set('tpa','tbi') COLLATE utf8_unicode_ci NOT NULL,
  `grade` set('b','a','a+') COLLATE utf8_unicode_ci NOT NULL,
  `status` set('tetap','freelance') COLLATE utf8_unicode_ci NOT NULL,
  `tanggal_masuk` date NOT NULL,
  `kode_pengajar` int(20) NOT NULL,
  `no_rek_bni` int(20) NOT NULL,
  `password` varchar(32) COLLATE utf8_unicode_ci NOT NULL,
  `jk` set('m','f') COLLATE utf8_unicode_ci NOT NULL
) ENGINE=InnoDB DEFAULT CHARSET=utf8 COLLATE=utf8_unicode_ci;
...
CREATE TABLE `pengumuman` (
  ...
  `file_attachment` varchar(100) COLLATE utf8_unicode_ci NOT NULL,
  `tanggal` date NOT NULL,
...
--
-- Table structure for table `pengumuman_perusahaan`
--

CREATE TABLE `pengumuman_perusahaan` (
  `id_pengumuman` int(11) NOT NULL,
  `id_cabang` char(10) COLLATE utf8_unicode_ci NOT NULL,
  `nomor` char(4) COLLATE utf8_unicode_ci NOT NULL,
  `isi` text COLLATE utf8_unicode_ci NOT NULL,
  `file_lampiran` varchar(50) COLLATE utf8_unicode_ci NOT NULL
) ENGINE=InnoDB DEFAULT CHARSET=utf8 COLLATE=utf8_unicode_ci;
...
CREATE TABLE `permohonan_cuti` (
  ...
  `id_user_pengganti` int(11) NOT NULL,
  `alasan` text COLLATE utf8_unicode_ci NOT NULL,
  `id_user_atasan` int(11) DEFAULT NULL,
  `read_atasan` enum('Y','N') COLLATE utf8_unicode_ci NOT NULL DEFAULT 'N',
  `id_user_hrd` int(11) DEFAULT NULL,
  `read_hrd` enum('Y','N') COLLATE utf8_unicode_ci NOT NULL DEFAULT 'N'
) ENGINE=InnoDB DEFAULT CHARSET=utf8 COLLATE=utf8_unicode_ci;
...
CREATE TABLE `permohonan_izin` (
  ...
  `id_user` int(11) NOT NULL,
  `tanggal` date NOT NULL,
  `tanggl_input` timestamp NOT NULL DEFAULT CURRENT_TIMESTAMP,
  `jenis_izin` enum('tdk_msk','terlambat','plng_awal') COLLATE utf8_unicode_ci NOT NULL,
  `alasan` text COLLATE utf8_unicode_ci NOT NULL,
  `id_user_pengesah` int(11) DEFAULT NULL
) ENGINE=InnoDB DEFAULT CHARSET=utf8 COLLATE=utf8_unicode_ci;

-- --------------------------------------------------------

--
-- Table structure for table `permohonan_lembur`
--

CREATE TABLE `permohonan_lembur` (
  `id_lembur` int(11) NOT NULL,
  `id_cabang` char(10) COLLATE utf8_unicode_ci NOT NULL,
  `id_user` int(11) NOT NULL,
  `tanggal_input` timestamp NOT NULL DEFAULT CURRENT_TIMESTAMP ON UPDATE CURRENT_TIMESTAMP,
  `id_user_atasan` int(11) NOT NULL
) ENGINE=InnoDB DEFAULT CHARSET=utf8 COLLATE=utf8_unicode_ci;

-- --------------------------------------------------------

--
-- Table structure for table `permohonan_penugasan`
--

CREATE TABLE `permohonan_penugasan` (
...
CREATE TABLE `program` (
  ...
  `nama_program` varchar(50) COLLATE utf8_unicode_ci NOT NULL,
  `harga` int(11) NOT NULL,
  `pendaftaran` int(11) NOT NULL,
  `sesi_kelas` tinyint(3) NOT NULL,
  `sesi_to` tinyint(3) NOT NULL
) ENGINE=InnoDB DEFAULT CHARSET=utf8 COLLATE=utf8_unicode_ci;
...
INSERT INTO `program` (`id_program`, `nama_program`, `harga`, `pendaftaran`, `sesi_kelas`, `sesi_to`) VALUES
(11, 'SILVER', 1200000, 295000, 32, 6),
(12, 'GOLD', 1500000, 295000, 50, 8),
(13, 'PLATINUM', 1800000, 295000, 78, 12),
(14, 'DIAMOND', 2000000, 295000, 98, 15);
...
--
-- Table structure for table `req_pembayaran_khusus`
--

CREATE TABLE `req_pembayaran_khusus` (
  `id_req_pembayaran` int(11) NOT NULL,
  `nomor` char(4) COLLATE utf8_unicode_ci NOT NULL,
  `tanggal_input` timestamp NOT NULL DEFAULT CURRENT_TIMESTAMP,
  `id_user_konsultan` int(11) DEFAULT NULL,
  `id_cabang` char(10) COLLATE utf8_unicode_ci NOT NULL,
  `nis` char(16) COLLATE utf8_unicode_ci NOT NULL,
  `cicilan1` int(11) NOT NULL,
  `cicilan2` int(11) NOT NULL,
  `cicilan3` int(11) NOT NULL,
  `cicilan4` int(11) NOT NULL,
  `id_user_man` int(11) DEFAULT NULL,
  `disetujui` enum('0','1') COLLATE utf8_unicode_ci NOT NULL DEFAULT '0'
) ENGINE=InnoDB DEFAULT CHARSET=utf8 COLLATE=utf8_unicode_ci;

--
-- Dumping data for table `req_pembayaran_khusus`
--

INSERT INTO `req_pembayaran_khusus` (`id_req_pembayaran`, `nomor`, `tanggal_input`, `id_user_konsultan`, `id_cabang`, `nis`, `cicilan1`, `cicilan2`, `cicilan3`, `cicilan4`, `id_user_man`, `disetujui`) VALUES
(1, '0001', '2017-12-01 15:21:44', 1, 'PUSAT', '17.0001.14.1', 15, 20, 23, 2, NULL, '0');

-- --------------------------------------------------------

--
-- Table structure for table `req_virtual_account`
--

CREATE TABLE `req_virtual_account` (
  `id_req_va` int(11) NOT NULL,
  `id_user_konsultan` int(11) NOT NULL,
  `id_cabang` char(10) COLLATE utf8_unicode_ci NOT NULL,
  `nomor` char(4) COLLATE utf8_unicode_ci NOT NULL,
  `tahun` year(4) NOT NULL,
  `id_user_man` int(11) DEFAULT NULL,
  `disetujui` set('0','1') COLLATE utf8_unicode_ci NOT NULL DEFAULT '0',
  `tanggal_input` timestamp NOT NULL DEFAULT CURRENT_TIMESTAMP ON UPDATE CURRENT_TIMESTAMP
) ENGINE=InnoDB DEFAULT CHARSET=utf8 COLLATE=utf8_unicode_ci;

--
-- Dumping data for table `req_virtual_account`
--

INSERT INTO `req_virtual_account` (`id_req_va`, `id_user_konsultan`, `id_cabang`, `nomor`, `tahun`, `id_user_man`, `disetujui`, `tanggal_input`) VALUES
(2, 1, 'PUSAT', '0001', 2017, NULL, '0', '2017-12-04 12:25:16');
...
--
-- Table structure for table `silabus_pengajar`
--

CREATE TABLE `silabus_pengajar` (
...
CREATE TABLE `siswa` (
  `nis` char(16) COLLATE utf8_unicode_ci NOT NULL,
  `virtual_account` varchar(30) COLLATE utf8_unicode_ci DEFAULT NULL,
  `id_cabang` char(10) COLLATE utf8_unicode_ci DEFAULT NULL,
  `no_pendaftaran` varchar(4) COLLATE utf8_unicode_ci NOT NULL,
  `tahun` year(4) NOT NULL,
  `nama` varchar(100) COLLATE utf8_unicode_ci NOT NULL,
  `email` varchar(100) COLLATE utf8_unicode_ci NOT NULL,
  `no_hp` varchar(16) COLLATE utf8_unicode_ci NOT NULL,
  `tmpt_lahir` varchar(50) COLLATE utf8_unicode_ci NOT NULL,
  `tgl_lahir` date NOT NULL,
  `jk` enum('m','f') COLLATE utf8_unicode_ci NOT NULL,
  `alamat` text COLLATE utf8_unicode_ci NOT NULL,
  `id_kec_siswa` char(7) COLLATE utf8_unicode_ci NOT NULL,
  `asal_sekolah` varchar(100) COLLATE utf8_unicode_ci NOT NULL,
  `tahun_lulus` year(4) NOT NULL,
  `jurusan` varchar(100) COLLATE utf8_unicode_ci NOT NULL,
  `nama_wali` varchar(100) COLLATE utf8_unicode_ci NOT NULL,
  `alamat_wali` text COLLATE utf8_unicode_ci NOT NULL,
  `id_kec_wali` char(7) COLLATE utf8_unicode_ci NOT NULL,
  `no_hp_wali` varchar(16) COLLATE utf8_unicode_ci NOT NULL,
  `email_wali` varchar(100) COLLATE utf8_unicode_ci NOT NULL,
  `id_program` int(11) NOT NULL,
  `tanggal_input` timestamp NOT NULL DEFAULT CURRENT_TIMESTAMP ON UPDATE CURRENT_TIMESTAMP
) ENGINE=InnoDB DEFAULT CHARSET=utf8 COLLATE=utf8_unicode_ci;
...
INSERT INTO `siswa` (`nis`, `virtual_account`, `id_cabang`, `no_pendaftaran`, `tahun`, `nama`, `email`, `no_hp`, `tmpt_lahir`, `tgl_lahir`, `jk`, `alamat`, `id_kec_siswa`, `asal_sekolah`, `tahun_lulus`, `jurusan`, `nama_wali`, `alamat_wali`, `id_kec_wali`, `no_hp_wali`, `email_wali`, `id_program`, `tanggal_input`) VALUES
('17.0001.14.1', '', 'PUSAT', '0001', 2017, 'Budi Prasetya', 'budi.prasetya@gmail.com', '087773445332', 'Surakarta', '1998-12-07', 'f', 'Kentingan', '3372040', 'SMA N 1 SURAKARTA', 2016, 'IPA', 'Supomo', 'Kentingan', '3372040', '081654123345', 'supomo11@gmail.com', 14, '2017-12-01 15:51:10');

-- --------------------------------------------------------

--
-- Table structure for table `siswa_pembayaran`
--

CREATE TABLE `siswa_pembayaran` (
  `id_pembayaran` int(11) NOT NULL,
  `nis_siswa` char(16) COLLATE utf8_unicode_ci NOT NULL,
  `biaya_program` int(11) NOT NULL,
  `biaya_pendaftaran` int(11) NOT NULL,
  `diskon` int(3) DEFAULT NULL,
  `pembayaran1` int(11) DEFAULT NULL,
  `tgl_pembayaran1` date DEFAULT NULL,
  `cicilan1` int(11) DEFAULT NULL,
  `tgl_cicilan1` date DEFAULT NULL,
  `cicilan2` int(11) DEFAULT NULL,
  `tgl_cicilan2` date DEFAULT NULL,
  `cicilan3` int(11) DEFAULT NULL,
  `tgl_cicilan3` date DEFAULT NULL,
  `cicilan4` int(11) DEFAULT NULL,
  `tgl_cicilan4` int(11) DEFAULT NULL
) ENGINE=InnoDB DEFAULT CHARSET=utf8 COLLATE=utf8_unicode_ci;

--
-- Dumping data for table `siswa_pembayaran`
--

INSERT INTO `siswa_pembayaran` (`id_pembayaran`, `nis_siswa`, `biaya_program`, `biaya_pendaftaran`, `diskon`, `pembayaran1`, `tgl_pembayaran1`, `cicilan1`, `tgl_cicilan1`, `cicilan2`, `tgl_cicilan2`, `cicilan3`, `tgl_cicilan3`, `cicilan4`, `tgl_cicilan4`) VALUES
(1, '17.0001.14.1', 2000000, 295000, 0, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL);

-- --------------------------------------------------------

--
-- Table structure for table `sub_permohonan_lembur`
--

CREATE TABLE `sub_permohonan_lembur` (
  `id_sub_lembur` int(11) NOT NULL,
  `id_lembur` int(11) NOT NULL,
  `tanggal_input` timestamp NOT NULL DEFAULT CURRENT_TIMESTAMP,
  `tanggal` date NOT NULL,
...
--
-- Table structure for table `sub_permohonan_penugasan`
--

CREATE TABLE `sub_permohonan_penugasan` (
  `id_sub_penugasan` int(11) NOT NULL,
  `id_penugasan` int(11) NOT NULL,
  `id_user` int(11) NOT NULL
) ENGINE=InnoDB DEFAULT CHARSET=utf8 COLLATE=utf8_unicode_ci;
...
--
-- Table structure for table `sub_req_virtual_account`
--

CREATE TABLE `sub_req_virtual_account` (
  `id_sub_req_va` int(11) NOT NULL,
  `id_req_va` int(11) NOT NULL,
  `nis` char(16) COLLATE utf8_unicode_ci NOT NULL,
  `virtual_account` varchar(30) COLLATE utf8_unicode_ci NOT NULL
) ENGINE=InnoDB DEFAULT CHARSET=utf8 COLLATE=utf8_unicode_ci;

--
-- Dumping data for table `sub_req_virtual_account`
--

INSERT INTO `sub_req_virtual_account` (`id_sub_req_va`, `id_req_va`, `nis`, `virtual_account`) VALUES
(2, 2, '17.0001.14.1', '11111111112');
...
CREATE TABLE `tamu` (
  ...
  `nama_wali` varchar(100) COLLATE utf8_unicode_ci NOT NULL,
  `no_hp_wali` varchar(16) COLLATE utf8_unicode_ci NOT NULL,
  `tahu_infinity` text COLLATE utf8_unicode_ci NOT NULL,
  `tanggal` timestamp NOT NULL DEFAULT CURRENT_TIMESTAMP ON UPDATE CURRENT_TIMESTAMP
) ENGINE=InnoDB DEFAULT CHARSET=utf8 COLLATE=utf8_unicode_ci;
...
CREATE TABLE `tmp_data` (
  `id_tmp_data` int(11) NOT NULL,
  `nama_table` varchar(30) COLLATE utf8_unicode_ci NOT NULL,
  `tmp` text COLLATE utf8_unicode_ci NOT NULL,
  `id_log_data` int(11) NOT NULL,
  `tanggal` timestamp NOT NULL DEFAULT CURRENT_TIMESTAMP
) ENGINE=InnoDB DEFAULT CHARSET=utf8 COLLATE=utf8_unicode_ci;
...
INSERT INTO `tmp_data` (`id_tmp_data`, `nama_table`, `tmp`, `id_log_data`, `tanggal`) VALUES
(1, 'user', '{"id_user":"1","no_pegawai":"123123123","nama":"Alif Bintoro","divisi":"Staff IT","email":"alifbintoro77@gmail.com","no_telp":"089679974236","id_access":"1","id_cabang":null,"password":"d9b1d7db4cd6e70935368a1efb10e377","foto":"","alamat":"Kartasura","status":"tetap"}', 11, '2017-11-29 09:56:24'),
(2, 'user', '{"id_user":"1","no_pegawai":"123123123","nama":"Alif Bintoro","divisi":"Staff IT","email":"alifbintoro77@gmail.com","no_telp":"089679974236","id_access":"1","id_cabang":null,"password":"6728a2ec6d65663fd0617a1d25977045","foto":"","alamat":"Kartasura","status":"tetap"}', 12, '2017-11-29 09:57:19'),
(3, 'user', '{"id_user":"1","no_pegawai":"123123123","nama":"Alif Bintoro","divisi":"Staff IT","email":"alifbintoro77@gmail.com","no_telp":"089679974236","id_access":"1","id_cabang":null,"password":"d9b1d7db4cd6e70935368a1efb10e377","foto":"","alamat":"Kartasura","status":"tetap"}', 13, '2017-11-29 09:57:43'),
(4, 'cabang', '{"id_cabang":"PUSAT","id_kecamatan":"3674060","nama":"Kantor Pusat Bimbel Infinity","alamat":"Jalan Pisok I Blok EA 15 No.1. Bintaro Sektor 5 Jurangmangu","kode_pos":"15222","email":"admin@bimbelinfinity.co.id","lat":"-6.26536","lng":"106.735","no_telp":"021-7358675","no_fax":"-","id_user_kc":"0"}', 18, '2017-11-29 11:00:14'),
(5, 'cabang', '{"id_cabang":"PUSAT","id_kecamatan":"3674060","nama":"Kantor Pusat Bimbel Infinity","alamat":"Jalan Pisok I Blok EA 15 No.1. Bintaro Sektor 5 Jurangmangu","kode_pos":"15222","email":"admin@bimbelinfinity.co.id","lat":"-6.26536","lng":"106.735","no_telp":"021-7358675","no_fax":"-","id_user_kc":"2"}', 19, '2017-11-30 03:40:08'),
(6, 'cabang', '{"id_cabang":"PUSAT","id_kecamatan":"3674060","nama":"Kantor Pusat Bimbel Infinity","alamat":"Jalan Pisok I Blok EA 15 No.1. Bintaro Sektor 5 Jurangmangu","kode_pos":"15222","email":"admin@bimbelinfinity.co.id","lat":"-6.26536","lng":"106.735","no_telp":"021-7358675","no_fax":"-","id_user_kc":null}', 20, '2017-11-30 03:42:04'),
(7, 'cabang', '{"id_cabang":"PUSAT","id_kecamatan":"3674060","nama":"Kantor Pusat Bimbel Infinity","alamat":"Jalan Pisok I Blok EA 15 No.1. Bintaro Sektor 5 Jurangmangu","kode_pos":"15222","email":"admin@bimbelinfinity.co.id","lat":"-6.26536","lng":"106.735","no_telp":"021-7358675","no_fax":"-","id_user_kc":"2"}', 21, '2017-11-30 03:42:08'),
(8, 'pengajar', '{"id_pengajar":"1","id_cabang":"PUSAT","nama":"Alif Bintoro","tmpt_lahir":"Surakarta","tgl_lahir":"2017-12-01","alamat":"Kartasura","id_kecamatan":"3311120","no_hp":"089679974236","email":"alifbintoro77@gmail.com","bidang":"tpa","grade":"a+","status":"freelance","tanggal_masuk":"2017-12-01","kode_pengajar":"2147483647","no_rek_bni":"2147483647","password":"","jk":"m"}', 23, '2017-12-01 09:46:23'),
(9, 'pengajar', '{"id_pengajar":"1","id_cabang":"PUSAT","nama":"Alif Bintoro","tmpt_lahir":"Surakarta","tgl_lahir":"2017-12-01","alamat":"Kartasura","id_kecamatan":"3311120","no_hp":"089679974236","email":"alifbintoro77@gmail.com","bidang":"tpa","grade":"a+","status":"freelance","tanggal_masuk":"2017-12-01","kode_pengajar":"2147483647","no_rek_bni":"2147483647","password":"5faa4ec1c0b6cce73e529f7d8d741fae","jk":"m"}', 24, '2017-12-01 09:56:23'),
(10, 'pengajar', '{"id_pengajar":"1","id_cabang":"PUSAT","nama":"Alif Bintoro","tmpt_lahir":"Surakarta","tgl_lahir":"1997-05-24","alamat":"Ngemplak","id_kecamatan":"3311120","no_hp":"089679974236","email":"alifbintoro77@gmail.com","bidang":"tpa","grade":"a+","status":"freelance","tanggal_masuk":"2017-12-01","kode_pengajar":"2147483647","no_rek_bni":"2147483647","password":"5faa4ec1c0b6cce73e529f7d8d741fae","jk":"m"}', 25, '2017-12-01 09:57:37'),
(11, 'pengajar', '{"id_pengajar":"1","id_cabang":"PUSAT","nama":"Alif Bintoro","tmpt_lahir":"Surakarta","tgl_lahir":"1997-05-24","alamat":"Ngemplak","id_kecamatan":"3311120","no_hp":"089679974236","email":"alifbintoro77@gmail.com","bidang":"tpa","grade":"a+","status":"freelance","tanggal_masuk":"2017-12-01","kode_pengajar":"2147483647","no_rek_bni":"2147483647","password":"c268bed6eb7d77f93f2b34b94247ca2b","jk":"m"}', 26, '2017-12-01 10:14:03'),
(12, 'siswa', '{"nis":"17.0001.12.2","virtual_account":"","id_cabang":"PUSAT","no_pendaftaran":"0001","tahun":"2017","nama":"Budi Prasetya","email":"budi.prasetya@gmail.com","no_hp":"087773445332","tmpt_lahir":"asd","tgl_lahir":"2017-12-01","jk":"m","alamat":"asd","id_kec_siswa":"3372040","asal_sekolah":"sd","tahun_lulus":"2016","jurusan":"asdf","nama_wali":"asdasf","alamat_wali":"sdafsdfa","id_kec_wali":"3372020","no_hp_wali":"786876876","email_wali":"wali@gmail.com","id_program":"12","tanggal_input":"2017-12-01 18:43:15"}', 30, '2017-12-01 15:36:07'),
(13, 'siswa', '{"nis":"17.0001.14.2","virtual_account":"","id_cabang":"PUSAT","no_pendaftaran":"0001","tahun":"2017","nama":"Budi Prasetya","email":"budi.prasetya@gmail.com","no_hp":"087773445332","tmpt_lahir":"Surakarta","tgl_lahir":"1998-12-07","jk":"m","alamat":"Kentingan","id_kec_siswa":"3372040","asal_sekolah":"SMA N 1 SURAKARTA","tahun_lulus":"2016","jurusan":"IPA","nama_wali":"Supomo","alamat_wali":"Kentingan","id_kec_wali":"3372040","no_hp_wali":"081654123345","email_wali":"wali@gmail.com","id_program":"14","tanggal_input":"2017-12-01 22:36:06"}', 31, '2017-12-01 15:37:36'),
(14, 'siswa', '{"nis":"17.0001.14.2","virtual_account":"","id_cabang":"PUSAT","no_pendaftaran":"0001","tahun":"2017","nama":"Budi Prasetya","email":"budi.prasetya@gmail.com","no_hp":"087773445332","tmpt_lahir":"Surakarta","tgl_lahir":"1998-12-07","jk":"m","alamat":"Kentingan","id_kec_siswa":"3372040","asal_sekolah":"SMA N 1 SURAKARTA","tahun_lulus":"2016","jurusan":"IPA","nama_wali":"Supomo","alamat_wali":"Kentingan","id_kec_wali":"3372040","no_hp_wali":"081654123345","email_wali":"supomo@gmail.com","id_program":"14","tanggal_input":"2017-12-01 22:37:36"}', 32, '2017-12-01 15:40:55'),
(15, 'siswa', '{"nis":"17.0001.14.2","virtual_account":"","id_cabang":"PUSAT","no_pendaftaran":"0001","tahun":"2017","nama":"Budi Prasetya","email":"budi.prasetya@gmail.com","no_hp":"087773445332","tmpt_lahir":"Surakarta","tgl_lahir":"1998-12-07","jk":"m","alamat":"Kentingan","id_kec_siswa":"3372040","asal_sekolah":"SMA N 1 SURAKARTA","tahun_lulus":"2016","jurusan":"IPA","nama_wali":"Supomo","alamat_wali":"Kentingan","id_kec_wali":"3372040","no_hp_wali":"081654123345","email_wali":"supomo11@gmail.com","id_program":"14","tanggal_input":"2017-12-01 22:40:55"}', 33, '2017-12-01 15:41:13'),
(16, 'siswa', '{"nis":"17.0001.14.1","virtual_account":"","id_cabang":"PUSAT","no_pendaftaran":"0001","tahun":"2017","nama":"Budi Prasetya","email":"budi.prasetya@gmail.com","no_hp":"087773445332","tmpt_lahir":"Surakarta","tgl_lahir":"1998-12-07","jk":"f","alamat":"Kentingan","id_kec_siswa":"3372040","asal_sekolah":"SMA N 1 SURAKARTA","tahun_lulus":"2016","jurusan":"IPA","nama_wali":"Supomo","alamat_wali":"Kentingan","id_kec_wali":"3372040","no_hp_wali":"081654123345","email_wali":"supomo11@gmail.com","id_program":"14","tanggal_input":"2017-12-01 22:41:13"}', 34, '2017-12-01 15:41:24'),
(17, 'siswa', '{"nis":"17.0001.14.2","virtual_account":"","id_cabang":"PUSAT","no_pendaftaran":"0001","tahun":"2017","nama":"Budi Prasetya","email":"budi.prasetya@gmail.com","no_hp":"087773445332","tmpt_lahir":"Surakarta","tgl_lahir":"1998-12-07","jk":"m","alamat":"Kentingan","id_kec_siswa":"3372040","asal_sekolah":"SMA N 1 SURAKARTA","tahun_lulus":"2016","jurusan":"IPA","nama_wali":"Supomo","alamat_wali":"Kentingan","id_kec_wali":"3372040","no_hp_wali":"081654123345","email_wali":"supomo11@gmail.com","id_program":"14","tanggal_input":"2017-12-01 22:41:24"}', 35, '2017-12-01 15:51:10'),
(18, 'req_pembayaran_khusus', '{"id_req_pembayaran":"1","nomor":"0001","tanggal_input":"2017-12-01 22:21:44","id_user_konsultan":"1","id_cabang":"PUSAT","nis":"17.0001.14.1","cicilan1":"1","cicilan2":"2","cicilan3":"2","cicilan4":"2","id_user_man":null,"disetujui":"0"}', 36, '2017-12-02 06:15:39'),
(19, 'req_pembayaran_khusus', '{"id_req_pembayaran":"1","nomor":"0001","tanggal_input":"2017-12-01 22:21:44","id_user_konsultan":"1","id_cabang":"PUSAT","nis":"17.0001.14.1","cicilan1":"1","cicilan2":"2","cicilan3":"23","cicilan4":"2","id_user_man":null,"disetujui":"0"}', 37, '2017-12-02 06:18:32'),
(20, 'req_pembayaran_khusus', '{"id_req_pembayaran":"1","nomor":"0001","tanggal_input":"2017-12-01 22:21:44","id_user_konsultan":"1","id_cabang":"PUSAT","nis":"17.0001.14.1","cicilan1":"1","cicilan2":"20","cicilan3":"23","cicilan4":"2","id_user_man":null,"disetujui":"0"}', 38, '2017-12-02 06:22:35'),
(21, 'req_pembayaran_khusus', '{"id_req_pembayaran":"1","nomor":"0001","tanggal_input":"2017-12-01 22:21:44","id_user_konsultan":"1","id_cabang":"PUSAT","nis":"17.0001.14.1","cicilan1":"10","cicilan2":"20","cicilan3":"23","cicilan4":"2","id_user_man":null,"disetujui":"0"}', 40, '2017-12-02 06:24:01'),
(22, 'req_virtual_account', '{"id_req_va":"1","id_user_konsultan":"1","id_cabang":"PUSAT","nomor":"0001","tahun":"2017","id_user_man":null,"disetujui":"0","tanggal_input":"2017-12-04 18:58:57"}', 50, '2017-12-04 12:11:23'),
(23, 'notula_rapat', '{"id_notula":"2","id_cabang":"PUSAT","id_user_notulen":"1","tanggal_input":"2017-12-10 19:10:29","agenda":"jasidj","tanggal":"2017-12-10","tempat":"askjd","isi_rapat":"<p>aksdjkasjd<\\/p>"}', 62, '2017-12-10 12:11:02');
...
CREATE TABLE `user` (
  `id_user` int(11) NOT NULL,
  `no_pegawai` varchar(20) COLLATE utf8_unicode_ci NOT NULL,
  `nama` varchar(100) COLLATE utf8_unicode_ci NOT NULL,
  `divisi` varchar(50) COLLATE utf8_unicode_ci NOT NULL,
  `email` varchar(100) COLLATE utf8_unicode_ci NOT NULL,
  ...
  `alamat` text COLLATE utf8_unicode_ci NOT NULL,
  `status` set('tetap','panggilan','pengganti','sementara') COLLATE utf8_unicode_ci DEFAULT NULL
) ENGINE=InnoDB DEFAULT CHARSET=utf8 COLLATE=utf8_unicode_ci;
...
INSERT INTO `user` (`id_user`, `no_pegawai`, `nama`, `divisi`, `email`, `no_telp`, `id_access`, `id_cabang`, `password`, `foto`, `alamat`, `status`) VALUES
(1, '123321123', 'Alif Bintoro', 'Staff IT', 'alifbintoro77@gmail.com', '089679974236', 1, NULL, 'd9b1d7db4cd6e70935368a1efb10e377', '', 'Kartasura', 'tetap'),
(2, '1233333333333', 'Dewa Pamungkas', 'Kepala Cabang', 'dewa@gmail.com', '0897267362736', 15, 'PUSAT', 'a366ff7e0a91a4be7fd068744204ade5', '', 'Solo', 'tetap');
...
ALTER TABLE `menu`
  ...
  ADD KEY `id_main_menu` (`id_main_menu`);

--
-- Indexes for table `notula_rapat`
--
ALTER TABLE `notula_rapat`
  ADD PRIMARY KEY (`id_notula`),
  ADD KEY `id_cabang` (`id_cabang`),
  ADD KEY `id_user_notulen` (`id_user_notulen`);
...
--
-- Indexes for table `pengumuman_perusahaan`
--
ALTER TABLE `pengumuman_perusahaan`
...
ALTER TABLE `permohonan_cuti`
  ...
  ADD KEY `id_user` (`id_user`),
  ADD KEY `id_user_pengganti` (`id_user_pengganti`),
  ADD KEY `id_user_atasan` (`id_user_atasan`),
  ADD KEY `id_user_hrd` (`id_user_hrd`),
  ADD KEY `id_cabang` (`id_cabang`);
...
ALTER TABLE `permohonan_izin`
  ...
  ADD KEY `id_cabang` (`id_cabang`),
  ADD KEY `id_user` (`id_user`),
  ADD KEY `id_user_pengesah` (`id_user_pengesah`);

--
-- Indexes for table `permohonan_lembur`
--
ALTER TABLE `permohonan_lembur`
...
--
-- Indexes for table `permohonan_penugasan`
--
ALTER TABLE `permohonan_penugasan`
...
--
-- Indexes for table `req_pembayaran_khusus`
--
ALTER TABLE `req_pembayaran_khusus`
  ADD PRIMARY KEY (`id_req_pembayaran`),
  ADD KEY `id_user_konsultan` (`id_user_konsultan`),
  ADD KEY `id_cabang` (`id_cabang`),
  ADD KEY `nis` (`nis`),
  ADD KEY `id_user_man` (`id_user_man`);

--
-- Indexes for table `req_virtual_account`
--
ALTER TABLE `req_virtual_account`
  ADD PRIMARY KEY (`id_req_va`),
  ADD KEY `id_user_konsultan` (`id_user_konsultan`),
  ADD KEY `id_cabang` (`id_cabang`),
  ADD KEY `id_user_man` (`id_user_man`);
...
--
-- Indexes for table `silabus_pengajar`
--
ALTER TABLE `silabus_pengajar`
...
ALTER TABLE `siswa`
  ADD PRIMARY KEY (`nis`),
  ADD UNIQUE KEY `email` (`email`,`no_hp`,`no_hp_wali`,`email_wali`),
  ADD KEY `id_program` (`id_program`),
  ADD KEY `id_cabang` (`id_cabang`),
  ADD KEY `id_kec_siswa` (`id_kec_siswa`),
  ADD KEY `id_kec_wali` (`id_kec_wali`);
...
--
-- Indexes for table `sub_permohonan_lembur`
--
ALTER TABLE `sub_permohonan_lembur`
  ADD PRIMARY KEY (`id_sub_lembur`),
  ADD KEY `id_lembur` (`id_lembur`);

--
-- Indexes for table `sub_permohonan_penugasan`
--
ALTER TABLE `sub_permohonan_penugasan`
  ADD PRIMARY KEY (`id_sub_penugasan`),
  ADD KEY `id_penugasan` (`id_penugasan`),
  ADD KEY `id_user` (`id_user`);

--
-- Indexes for table `sub_req_virtual_account`
--
ALTER TABLE `sub_req_virtual_account`
  ADD PRIMARY KEY (`id_sub_req_va`),
  ADD KEY `id_req_va` (`id_req_va`),
  ADD KEY `nis` (`nis`);
...
ALTER TABLE `tmp_data`
  ADD PRIMARY KEY (`id_tmp_data`),
  ADD KEY `id_log_data` (`id_log_data`);
...
--
ALTER TABLE `log_data`
  MODIFY `id_log_data` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=63;
--
...
--
-- AUTO_INCREMENT for table `notula_rapat`
--
ALTER TABLE `notula_rapat`
  MODIFY `id_notula` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=2;
--
-- AUTO_INCREMENT for table `otorisasi`
--
ALTER TABLE `otorisasi`
  MODIFY `id_otorisasi` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=5;
--
...
--
-- AUTO_INCREMENT for table `pengumuman_perusahaan`
--
ALTER TABLE `pengumuman_perusahaan`
...
--
-- AUTO_INCREMENT for table `permohonan_lembur`
--
ALTER TABLE `permohonan_lembur`
  MODIFY `id_lembur` int(11) NOT NULL AUTO_INCREMENT;
--
-- AUTO_INCREMENT for table `permohonan_penugasan`
--
ALTER TABLE `permohonan_penugasan`
...
--
-- AUTO_INCREMENT for table `req_pembayaran_khusus`
--
ALTER TABLE `req_pembayaran_khusus`
  MODIFY `id_req_pembayaran` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=2;
--
-- AUTO_INCREMENT for table `req_virtual_account`
--
ALTER TABLE `req_virtual_account`
  MODIFY `id_req_va` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=3;
--
...
--
-- AUTO_INCREMENT for table `silabus_pengajar`
--
ALTER TABLE `silabus_pengajar`
...
--
-- AUTO_INCREMENT for table `sub_permohonan_lembur`
--
ALTER TABLE `sub_permohonan_lembur`
  MODIFY `id_sub_lembur` int(11) NOT NULL AUTO_INCREMENT;
--
-- AUTO_INCREMENT for table `sub_permohonan_penugasan`
--
ALTER TABLE `sub_permohonan_penugasan`
  MODIFY `id_sub_penugasan` int(11) NOT NULL AUTO_INCREMENT;
--
-- AUTO_INCREMENT for table `sub_req_virtual_account`
--
ALTER TABLE `sub_req_virtual_account`
  MODIFY `id_sub_req_va` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=3;
--
...
--
ALTER TABLE `tmp_data`
  MODIFY `id_tmp_data` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=24;
--
...
--
ALTER TABLE `cabang`
  ADD CONSTRAINT `fk_kecamatan_cabang` FOREIGN KEY (`id_kecamatan`) REFERENCES `kecamatan` (`id_kecamatan`) ON DELETE SET NULL ON UPDATE CASCADE;
...
--
ALTER TABLE `kecamatan`
  ADD CONSTRAINT `districts_regency_id_foreign` FOREIGN KEY (`id_kabupaten`) REFERENCES `kabupaten` (`id_kabupaten`);

--
-- Constraints for table `log_data`
--
ALTER TABLE `log_data`
  ADD CONSTRAINT `fk_log_user` FOREIGN KEY (`id_user`) REFERENCES `user` (`id_user`) ON DELETE NO ACTION;

--
-- Constraints for table `log_login`
--
ALTER TABLE `log_login`
  ADD CONSTRAINT `fk_login_log` FOREIGN KEY (`id_user`) REFERENCES `user` (`id_user`) ON UPDATE CASCADE;

--
-- Constraints for table `menu`
--
ALTER TABLE `menu`
  ADD CONSTRAINT `fk_menu_sub` FOREIGN KEY (`id_main_menu`) REFERENCES `menu` (`id_menu`) ON DELETE CASCADE;

--
-- Constraints for table `otorisasi`
--
ALTER TABLE `otorisasi`
  ADD CONSTRAINT `fk_otoritas_access` FOREIGN KEY (`id_access`) REFERENCES `access` (`id_access`) ON UPDATE CASCADE,
  ADD CONSTRAINT `fk_otoritas_user` FOREIGN KEY (`id_user`) REFERENCES `user` (`id_user`) ON DELETE CASCADE ON UPDATE CASCADE;

--
-- Constraints for table `pengajar`
--
ALTER TABLE `pengajar`
  ADD CONSTRAINT `fk_pengajar_cabang` FOREIGN KEY (`id_cabang`) REFERENCES `cabang` (`id_cabang`) ON UPDATE CASCADE,
  ADD CONSTRAINT `fk_pengajar_kecamatan` FOREIGN KEY (`id_kecamatan`) REFERENCES `kecamatan` (`id_kecamatan`) ON UPDATE CASCADE;

--
-- Constraints for table `pengumuman_perusahaan`
--
ALTER TABLE `pengumuman_perusahaan`
  ADD CONSTRAINT `fk_pengumuman_perusahaan_cabang` FOREIGN KEY (`id_cabang`) REFERENCES `cabang` (`id_cabang`) ON DELETE CASCADE;

--
-- Constraints for table `permohonan_cuti`
--
ALTER TABLE `permohonan_cuti`
  ADD CONSTRAINT `fk_cuti_atasan` FOREIGN KEY (`id_user_atasan`) REFERENCES `user` (`id_user`) ON DELETE CASCADE,
  ADD CONSTRAINT `fk_cuti_cabang` FOREIGN KEY (`id_cabang`) REFERENCES `cabang` (`id_cabang`) ON DELETE CASCADE,
  ADD CONSTRAINT `fk_cuti_hrd` FOREIGN KEY (`id_user_hrd`) REFERENCES `user` (`id_user`) ON DELETE CASCADE,
  ADD CONSTRAINT `fk_cuti_pengganti` FOREIGN KEY (`id_user_pengganti`) REFERENCES `user` (`id_user`) ON DELETE CASCADE,
  ADD CONSTRAINT `fk_cuti_user` FOREIGN KEY (`id_user`) REFERENCES `user` (`id_user`) ON DELETE CASCADE;

--
-- Constraints for table `permohonan_izin`
--
ALTER TABLE `permohonan_izin`
  ADD CONSTRAINT `fk_izin_cabang` FOREIGN KEY (`id_cabang`) REFERENCES `cabang` (`id_cabang`) ON DELETE CASCADE,
  ADD CONSTRAINT `fk_izin_pengesah` FOREIGN KEY (`id_user_pengesah`) REFERENCES `user` (`id_user`) ON DELETE CASCADE,
  ADD CONSTRAINT `fk_izin_user` FOREIGN KEY (`id_user`) REFERENCES `user` (`id_user`) ON DELETE CASCADE;

--
-- Constraints for table `permohonan_lembur`
--
ALTER TABLE `permohonan_lembur`
  ADD CONSTRAINT `fk_lembur_atasan` FOREIGN KEY (`id_user_atasan`) REFERENCES `user` (`id_user`) ON DELETE CASCADE,
  ADD CONSTRAINT `fk_lembur_cabang` FOREIGN KEY (`id_cabang`) REFERENCES `cabang` (`id_cabang`) ON DELETE CASCADE,
  ADD CONSTRAINT `fk_lembur_user` FOREIGN KEY (`id_user`) REFERENCES `user` (`id_user`) ON DELETE CASCADE;

--
-- Constraints for table `permohonan_penugasan`
--
ALTER TABLE `permohonan_penugasan`
  ADD CONSTRAINT `fk_penugasan_cabang` FOREIGN KEY (`id_cabang`) REFERENCES `cabang` (`id_cabang`) ON DELETE CASCADE,
  ADD CONSTRAINT `fk_penugasan_petugas` FOREIGN KEY (`id_user_petugas`) REFERENCES `user` (`id_user`) ON DELETE CASCADE;

--
-- Constraints for table `req_pembayaran_khusus`
--
ALTER TABLE `req_pembayaran_khusus`
  ADD CONSTRAINT `fk_req_pem_cabang` FOREIGN KEY (`id_cabang`) REFERENCES `cabang` (`id_cabang`) ON UPDATE CASCADE,
  ADD CONSTRAINT `fk_req_pem_konsultan` FOREIGN KEY (`id_user_konsultan`) REFERENCES `user` (`id_user`) ON DELETE SET NULL ON UPDATE CASCADE,
  ADD CONSTRAINT `fk_req_pem_manajer` FOREIGN KEY (`id_user_man`) REFERENCES `user` (`id_user`) ON DELETE SET NULL ON UPDATE CASCADE,
  ADD CONSTRAINT `fk_req_pem_siswa` FOREIGN KEY (`nis`) REFERENCES `siswa` (`nis`) ON DELETE CASCADE ON UPDATE CASCADE;

--
-- Constraints for table `req_virtual_account`
--
ALTER TABLE `req_virtual_account`
  ADD CONSTRAINT `fk_va_cabang` FOREIGN KEY (`id_cabang`) REFERENCES `cabang` (`id_cabang`) ON UPDATE CASCADE,
  ADD CONSTRAINT `fk_va_konsultan` FOREIGN KEY (`id_user_konsultan`) REFERENCES `user` (`id_user`) ON UPDATE CASCADE,
  ADD CONSTRAINT `fk_va_manajer` FOREIGN KEY (`id_user_man`) REFERENCES `user` (`id_user`) ON UPDATE CASCADE;

--
-- Constraints for table `silabus_pengajar`
--
ALTER TABLE `silabus_pengajar`
  ADD CONSTRAINT `fk_silabus_cabang` FOREIGN KEY (`id_cabang`) REFERENCES `cabang` (`id_cabang`) ON UPDATE CASCADE,
  ADD CONSTRAINT `fk_silabus_program` FOREIGN KEY (`id_program`) REFERENCES `program` (`id_program`) ON UPDATE CASCADE;

--
-- Constraints for table `siswa`
--
ALTER TABLE `siswa`
  ADD CONSTRAINT `fk_siswa_cabang` FOREIGN KEY (`id_cabang`) REFERENCES `cabang` (`id_cabang`) ON UPDATE CASCADE,
  ADD CONSTRAINT `fk_siswa_kecamatan_sis` FOREIGN KEY (`id_kec_siswa`) REFERENCES `kecamatan` (`id_kecamatan`) ON UPDATE CASCADE,
  ADD CONSTRAINT `fk_siswa_kecamatan_wali` FOREIGN KEY (`id_kec_wali`) REFERENCES `kecamatan` (`id_kecamatan`) ON UPDATE CASCADE,
  ADD CONSTRAINT `fk_siswa_program` FOREIGN KEY (`id_program`) REFERENCES `program` (`id_program`) ON UPDATE CASCADE;

--
-- Constraints for table `siswa_pembayaran`
--
ALTER TABLE `siswa_pembayaran`
  ADD CONSTRAINT `fk_siswa_cicilan` FOREIGN KEY (`nis_siswa`) REFERENCES `siswa` (`nis`) ON DELETE CASCADE ON UPDATE CASCADE;

--
-- Constraints for table `sub_permohonan_lembur`
--
ALTER TABLE `sub_permohonan_lembur`
  ADD CONSTRAINT `fk_sub_lembur` FOREIGN KEY (`id_lembur`) REFERENCES `permohonan_lembur` (`id_lembur`) ON DELETE CASCADE;

--
-- Constraints for table `sub_permohonan_penugasan`
--
ALTER TABLE `sub_permohonan_penugasan`
  ADD CONSTRAINT `fk_sub_penugasan` FOREIGN KEY (`id_penugasan`) REFERENCES `permohonan_penugasan` (`id_penugasan`) ON DELETE CASCADE,
  ADD CONSTRAINT `fk_sub_penugasan_user` FOREIGN KEY (`id_user`) REFERENCES `user` (`id_user`) ON DELETE CASCADE;

--
-- Constraints for table `sub_req_virtual_account`
--
ALTER TABLE `sub_req_virtual_account`
  ADD CONSTRAINT `fk_sub_va_nis` FOREIGN KEY (`nis`) REFERENCES `siswa` (`nis`) ON DELETE CASCADE ON UPDATE CASCADE,
  ADD CONSTRAINT `fk_sub_va_va` FOREIGN KEY (`id_req_va`) REFERENCES `req_virtual_account` (`id_req_va`) ON DELETE CASCADE ON UPDATE CASCADE;

--
-- Constraints for table `tmp_data`
--
ALTER TABLE `tmp_data`
  ADD CONSTRAINT `fk_tmp_log_data` FOREIGN KEY (`id_log_data`) REFERENCES `log_data` (`id_log_data`) ON UPDATE CASCADE;

--
-- Constraints for table `user`
--
ALTER TABLE `user`
  ADD CONSTRAINT `fk_user_access` FOREIGN KEY (`id_access`) REFERENCES `access` (`id_access`) ON UPDATE CASCADE,
  ADD CONSTRAINT `fk_user_cabang` FOREIGN KEY (`id_cabang`) REFERENCES `cabang` (`id_cabang`) ON UPDATE CASCADE;
