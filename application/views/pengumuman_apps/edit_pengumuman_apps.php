	...
	<div class="row">
		<div class="col-md-12 col-sm-12 col-xs-12">
			<div class="x_panel">
				...
				<div class="x_content">
					<form role="form" method="POST" action="<?php echo base_url('pengumuman_apps/action_edit/?PengumumanID='.$row['id_pengumuman']); ?>" autocomplete="off" enctype="multipart/form-data" accept-charset="utf-8">
						<div class="row">
							<div class="col-md-12">
								...
								<div class="form-group">
									...
									<div class="fileupload fileupload-new" data-provides="fileupload">
										<div class="fileupload-new thumbnail" style="width: 50%; height: 200px;">
			                            	...
			                            	<img src="<?php echo base_url('assets/img/pengumuman/'.$row['foto']); ?>" alt="">
			                            	<?php endif; ?>
										</div>
