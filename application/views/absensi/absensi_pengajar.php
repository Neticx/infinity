<?php if ( ! defined('BASEPATH')) exit('No direct script access allowed'); ?>
	<div class="row">
		<div class="col-md-4 col-sm-4 col-xs-4">
			<div class="x_panel">
				<div class="x_title">
					<h2>Generate Absensi Pengajar</h2>
	...
	<script type='text/javascript'>
		...
		function generateQR(){
			...
			if(jenis == 'masuk'){
				$.ajax({
					url: '<?php echo base_url('absensi/gen_absensi_masuk/?cabangID='.$cabangID.'&tipe=pengajar'); ?>',
					type: 'GET',
					dataType: 'json',
				...
				$.ajax({
					url: '<?php echo base_url('absensi/gen_absensi_pulang/?cabangID='.$cabangID.'&tipe=pengajar'); ?>',
					type: 'GET',
					dataType: 'json',
					success: function (hasil) {
						urlAbsen = hasil.url;
