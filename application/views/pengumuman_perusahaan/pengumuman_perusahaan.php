...
?>
		<div class="row">
            <div class="col-md-12 col-sm-12 col-xs-12">
                <div class="x_panel">
                  <div class="x_title">
                    <h2>List Pengumuman Perusahaan</h2>
                  ...
                  <div class="x_content">
						<table id="table"
				            data-toggle="table"
				            data-url="<?php echo base_url('pengumuman_perusahaan/list_data'); ?>"
		...
		<script type="text/javascript">
			function doHapus(id, judul){
				...
				function(){
					window.location.href = "<?php echo base_url('pengumuman_perusahaan/delete/?PengumumanID='); ?>" + id;
				});
			}
		</script>