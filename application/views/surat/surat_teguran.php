...
<div class="row">
  <div class="col-md-12 col-sm-12 col-xs-12">
    <div class="x_panel">
      ...
      <div class="x_content">
        <form role="form" method="POST" action="<?php echo base_url('surat/action_add_st/'); ?>" autocomplete="off" enctype="multipart/form-data" accept-charset="utf-8">
