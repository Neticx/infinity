<?php if ( ! defined('BASEPATH')) exit('No direct script access allowed');
	...
	$pdf->Ln(7);
	$w = $pdf->GetStringWidth("No. ".$no_surat);
	$pdf->SetX(($pdf->w -$w)/2);
	$pdf->SetFont('Arial','',11);
	$pdf->Cell($w,9,"No. ".$no_surat,0,0,'C');
	$pdf->Ln(15);
	$pdf->Cell(0,9,"Dengan ini saya,",0,1,'J');
	$pdf->Cell(10);
	$pdf->Cell(1,6,"Nama",0,0,'L');
	$pdf->Cell(48);
	$pdf->Cell(2,6," : ".$nama_pegawai,0,1,'L');
	$pdf->Cell(10);
	$pdf->Cell(1,6,"Jabatan",0,0,'L');
	$pdf->Cell(48);
	$pdf->Cell(2,6," : ".$jabatan,0,1,'L');
	$pdf->Ln(10);
	$pdf->MultiCell(0,6,"Mengajukan pencairan uang untuk kegiatan ".$kegiatan." sebesar ".formatRP($nominal)." Lampiran pengajuan pencairan uang kami sertakan dalam attachment surat ini.");
	...
	$pdf->Ln(20);
	$pdf->Cell(0,6,$nama_pegawai,0,1,"R");
	$pdf->Output("PermintaanKeuangan_".$no_surat.".pdf","I");